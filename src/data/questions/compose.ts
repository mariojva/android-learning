...
val showButton by remember {
  ...
  },
  {
    ...
    introducedInWeek: 6,
    symptom:
      "The compiler report marks `OrderSummary` as restartable but *not* skippable. It recomposes whenever its parent does, even when nothing it displays has changed.",
