...
export const SYSTEM_DESIGN_QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    stage: "reason",
    ownership: "design",
    concepts: ["repository", "cache-invalidation", "compose-stability"],
    estimatedMinutes: 60,
    completedCount: 6200,
  ...
  },
  {
    ...
    stage: "reason",
    ownership: "design",
    concepts: ["single-source-of-truth", "cache-invalidation", "background-work"],
    estimatedMinutes: 60,
    completedCount: 3900,
  ...
  },
  {
    ...
    stage: "reason",
    ownership: "design",
    concepts: ["stateflow", "single-source-of-truth", "room"],
    estimatedMinutes: 60,
    completedCount: 5400,
    companyTags: ["Meta", "Google"],
    introducedInWeek: 9,
  ...
  },
  {
    ...
    stage: "reason",
    ownership: "design",
    concepts: ["cold-hot", "stateflow", "background-work"],
    estimatedMinutes: 60,
    completedCount: 3400,
