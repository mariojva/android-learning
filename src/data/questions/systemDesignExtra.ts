...
export const SYSTEM_DESIGN_EXTRA_QUESTIONS: Question[] = [
  /* ================================================================ */
  {
    ...
    stage: "reason",
    ownership: "design",
    concepts: ["flow-operators", "cancellation", "repository"],
    estimatedMinutes: 60,
    completedCount: 1700,
    introducedInWeek: 12,
    designBrief:
  ...
  /* ================================================================ */
  {
    ...
    stage: "reason",
    ownership: "design",
    concepts: ["compose-stability", "cache-invalidation", "repository"],
    estimatedMinutes: 60,
    completedCount: 1500,
    introducedInWeek: 12,
    designBrief:
  ...
  /* ================================================================ */
  {
    ...
    stage: "reason",
    ownership: "design",
    concepts: ["room", "ui-state", "repository"],
    estimatedMinutes: 60,
    completedCount: 1400,
    introducedInWeek: 12,
    designBrief:
  ...
  /* ================================================================ */
  {
    ...
    stage: "reason",
    ownership: "design",
    concepts: ["cache-invalidation", "single-source-of-truth", "idempotency"],
    estimatedMinutes: 60,
    completedCount: 1600,
    introducedInWeek: 12,
    designBrief:
